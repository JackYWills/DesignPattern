...
import observer.origin.observer.CurrentConditionsDisplay;
import observer.origin.observer.ForecastDisplay;
import observer.origin.observer.StatisticsDisplay;
import observer.origin.subject.WeatherData;
